...
//! unique identification for resources, elements, or entities. Identifiers are
//! used to maintain consistent references across systems and enable
//! interoperability by providing stable, unique identifiers that persist across
//! systems.
//! 
//! ## Purpose
//! 
...
mod tests {
    ...
    fn test_serde_json_from_reader() {
        ...
        assert_eq!(actual.system, "urn:ietf:rfc:3986");
    }
}
