...
pub static DEFINITIONS_DIR: std::sync::LazyLock<std::path::PathBuf> = std::sync::LazyLock::new(|| {
...
fn parse_profiles_types() {
    ...
    let bundle: parse::profiles_types::Bundle =
    ...
    bundle
        ...
        .for_each(|resource| {
            parse::profiles_types::resource_into_rust(&resource)
